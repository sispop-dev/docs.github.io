title: Sispop Documentation | Sispop Sub Address
description: Sispop and Monero use Sub Addresses. A subaddress should be the default address you share to someone to receive Sispop, Monero or other cryptonote coins. By providing a unique subaddress for each anticipated payment you will know for what you are being paid.

# Subaddress

Subaddress is what you should be using by default to receive Sispop.
...
This way services like [Shapeshift](https://shapeshift.io) wouldn't know it is you again receving Sispop.

Note it won't help if you have an account with the service. Then your payouts are already linked in the service database, regardless of Sispop.

## Group funds into accounts

!!! Note
    Feel free to skip this if your are new to Sispop. Accounts are not essential and currently not supported by the GUI.
...
------------|------------------|-------------------------------------------------------------
0           | 1                | identifies the network and address type; [116](https://github.com/sispop-dev/sispop/blob/master/src/cryptonote_config.h#L183) - mainnet; [36](https://github.com/sispop-dev/sispop/blob/master/src/cryptonote_config.h#L226) - stagenet; [158](https://github.com/sispop-dev/sispop/blob/master/src/cryptonote_config.h#L203) - testnet
