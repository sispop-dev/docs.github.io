title: Sispop.network Documentation | Sispop Debugging
description: This section contains general instructions for debugging failed installs or problems encountered with Sispop. First ensure you are running the latest version built from the Github repo.
...
Run with `valgrind /path/to/sispopd`. It will be slow.
